...
\newcommand{\maintitle}{Common\ Lisp\ 快速参考}
...
%
%
\documentclass[fontsize=8pt,pagesize,twoside,footinclude=false,headinclude=false]{scrartcl}
%
%
%%%%%%%%%%%%%%%%%%
